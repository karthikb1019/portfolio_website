...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/chandrashekar-kasireddy/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@chandhu.xx_",
    icon: Instagram,
    url: "https://www.instagram.com/chandhu.xx_/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@ChandraShekar",
    icon: Youtube,
    url: "https://www.youtube.com/@ChandrashekarreddyKasiredd-h6l",
    color: "#FF0000",
